...
3. Pasamos entonces a la limpieza de datos de la base de datos proporcionada y estructurarla de la misma forma que tenemos nuestro DER. Espongo la operaciones principales que he realizado con Pandas.
   ...
   La columna de 'first_name' y 'last_name' las he sustituido por 'name' a secas con el full name de actores para poder trabajar con esa columna de una manera más fácil al relacionarla con otros id. Borramos de aquí una actriz que posee dos id (como son nombres inventados no podemos saber si existen dos 'Susan Davies').
